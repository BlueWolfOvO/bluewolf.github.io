...
const ap = new APlayer({
    ...
    audio: [
      ...
      },
      {
        ...
        lrc: '/dist/Bloom of Youth-清水準一.lrc',
      },
      {
        ...
        cover: 'http://p2.music.126.net/boWhszSsHB1fvQTxtiI98Q==/109951163156134515.jpg',
		    lrc: '/dist/A little story（纯钢琴）-Masque_Jupiter.lrc',
      },
      {
        ...
        cover: 'http://p1.music.126.net/tplflfaOo8WDs4lx3jkhAg==/18755469348405559.jpg',
		    lrc: '/dist/Hello,shooting-star-moumoon.lrc',
      },
      {
        name: '小さな恋のうた',
        artist: '高橋李依',
